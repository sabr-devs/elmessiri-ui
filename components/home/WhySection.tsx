    ...
    <section className={cn('client', className)}>
      <div className="container overflow-hidden max-lg:!px-0">
        <div className=" px-10px mx-auto max-w-[550px] text-center max-lg:px-2.5">
          ...
          {sectionDetails && <p className="text-light mb-15">لأننا نؤمن بأنه المنهج المتميز بقدرته على تجاوز العتاد المادي للنظريات المادية المتمركزة حول الخطاب الغربي (Western-centric discourse)، من خلال رؤيته التي تضع الإنسان في مركز العملية البحثية، وتستعيد للبحث العلمي إنسانيته المفقودة، بعيداً عن الانحصار في إطار الموضوعية المتلقية وأوهام الحيادية المطلقة.</p>}
        </div>
